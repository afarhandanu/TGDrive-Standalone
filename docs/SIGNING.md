...
Android treats two APKs with the same `applicationId` but different signatures as different trust chains. TGDrive therefore never creates a release key inside CI.
