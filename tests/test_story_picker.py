        ...
        with tempfile.TemporaryDirectory() as temp:
            ...
            with patch.object(picker.urllib.request, 'urlopen', side_effect=fetch):
                for story_id in ids:
                    ...
                    self.assertEqual(output.parent.name, story_id)
                    self.assertEqual(output.parent.parent.name, 'stories')
                    self.assertEqual(output.parent.parent.parent.name, 'pak_pkw')
